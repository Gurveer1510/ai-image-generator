...
const CreatePost = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h1 className='font-extrabold text-2xl text-[#222328]'>Create</h1>
      ...
      >
        ...
        <div className='mt-5 flex gap-5'>
              <button
                ...
                className='text-white bg-green-700 font-medium rounded-md text-sm sm:w-full w-auto px-5 py-2.5 text-center'
              >
                {
        ...
        <div className='mt-10'>
                ...
                <button 
                  type='submit'
                  className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm sm:w-full w-auto px-5 py-2.5 text-center'
                >
                  {
